...
const Card = () => {
  return (
    <div className="w-72 min-h-100 h-100 rounded-xl shadow-md p-4 flex flex-col bg-white ">
      <h2 className="font-bold text-xs">Organization UI Components</h2>
      <p className="text-neutral-600 mt-2 text-[10px]">
        Clerks UI components add turn-key simplicity to complex Organization
        management tasks.
      </p>
      <div className="flex items-center justify-center">
        <button className="flex items-center gap-1 text-xs mt-4 shadow-md rounded-lg px-2 py-1">
          <Image
            src={logo}
            alt="logo"
            width={50}
