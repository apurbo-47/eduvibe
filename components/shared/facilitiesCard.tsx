...
const FacilitiesCard = () => {
  return (
    <motion.div
      ...
      className="w-full max-w-330 mx-auto rounded-xl px-5 py-10 md:p-20 bg-[#F5F7FA] "
    >
      <div className=" grid grid-cols-2  lg:grid-cols-4 gap-2.5 md:gap-5  ">
        <motion.div
          variants={animations.fadeRight}
          className="order-3 lg:order-1 border border-white rounded-3xl bg-white p-2.5 md:p-5"
        >
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
          className="order-1 col-span-2 lg:order-2 text-center max-w-lg mx-auto "
        >
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
          className="order-4 lg:order-4 border border-white rounded-3xl bg-white p-2.5 md:p-5"
        >
          <h3 className="text-sm md:text-xl font-bold mb-2.5 md:mb-5">
            Global Learning Hub
          </h3>
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
          className="order-5 lg:order-5 border border-white rounded-3xl bg-white p-1.5 md:p-2.5 "
        >
          <div className="flex">
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
          className="order-6 lg:order-6 border border-white rounded-3xl bg-white p-2.5 md:p-5"
        >
          <h3 className="text-sm md:text-xl font-bold mb-2.5 md:mb-5">
            World Class Faculty
          </h3>
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
          className="order-7 lg:order-7 border border-white rounded-3xl bg-white p-2.5 md:p-5"
        >
          <h3 className="text-sm md:text-xl font-bold mb-2.5 md:mb-5">
            Global Learning Hub
          </h3>
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
          className="order-8 lg:order-8 border border-white rounded-3xl bg-white p-1.5 md:p-2.5 "
        >
          <div className="flex">
            <button className="border border-[#4B5563] py-1 px-1 md:py-2 md:px-4 -rotate-17 md:-rotate-15 rounded-full mt-8 md:mt-10 text-xs md:text-sm text-[#1F2A37]">
              Personalized Plan
